...
class TestResCurrencyRate(TransactionCase):
    ...
    def test_date_up_to_last_rate(self):
        ...
        self.assertEqual(
            rate["foreign_rate"], 120.439, "Rate should be 120.439 for 2025-07-29"
        )
    ...
    def test_date_before_to_first_rate(self):
        ...
        self.assertEqual(
            rate["foreign_rate"], 118.439, "Rate should be 118.439 for 2025-07-17"
        )
    ...
    def test_date_equal_to_a_rate_date(self):
        ...
        self.assertEqual(
            rate["foreign_rate"], 119.439, "Rate should be 119.439 for 2025-07-21"
        )
